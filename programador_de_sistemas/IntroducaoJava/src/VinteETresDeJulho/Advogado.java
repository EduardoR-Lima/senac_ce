...
public class Advogado extends Funcionario {
	...
	public Advogado(String nome, double salario, Integer matricula, double peso, int idade,
			Integer OAB, String vara) {
	...
	public String toString() {
		return "Advogado [OAB=" + OAB + ", vara=" + vara + ", nome=" + nome + ", salario=" + salario + ", matricula="
				+ matricula + ", peso=" + peso + ", idade=" + idade + ", toString()=" + ", getNome()=" + getNome()
